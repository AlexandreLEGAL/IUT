...
insert into  ETAPES values (1, to_date('06-jul-97', 'dd-mon-yy'),'Rouen','Forges-les-Eaux', 192);
insert into  ETAPES values (2, to_date('07-jul-97', 'dd-mon-yy'),'St-Valery-en-Caux','Vire', 262);
insert into  ETAPES values (3, to_date('08-jul-97', 'dd-mon-yy'),'Vire','Plumelec', 224);
